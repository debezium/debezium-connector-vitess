...
vtctlclient -grpc_auth_static_client_creds grpc_static_client_auth.json InitShardMaster -force test_unsharded_keyspace/0 zone1-100
...
vtctlclient -grpc_auth_static_client_creds grpc_static_client_auth.json InitShardMaster -force test_sharded_keyspace/-80 zone1-200
vtctlclient -grpc_auth_static_client_creds grpc_static_client_auth.json InitShardMaster -force test_sharded_keyspace/80- zone1-300
